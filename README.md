...
fred is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
Then you can interact with fred by typing `fred help`.
    ...
    fred> animate me <query> - The same thing as `image me`, except adds a few
...
## Custom StreamSend Vars

Set the following values when deploying:

  - HUBOT_SLACK_TOKEN = <slack_token>
  - HEROKU_URL = <url to hubot> # to keep him awake
